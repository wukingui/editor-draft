...
export class MyEditor extends React.Component {
  ...
  componentDidMount() {
    ...
    if (!this.props.fixedEditorControls) return;
  ...
  render() {
    const self = this
    const { editorState, rendered, placeholder, expandControl } = this.state
    ...
    return(<div className="RichEditor-editor">
            ...
            {displayControls ?
              <div id="editor-controls"><Controls
